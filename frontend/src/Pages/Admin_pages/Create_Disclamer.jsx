...
import {  useDisclamer_ApiMutation } from '../../Redux/Api';
function Create_Disclamer() {
  let [AboutApifnc,{data}]=useDisclamer_ApiMutation()
    ...
    <div className="pt-10 flex flex-col items-center">
        <div className="px-20 md:w-[65%] ">
          <div className='flex justify-between items-center'>
            <span><h3 className=" font-bold text-[24px] text-center ">Disclamer</h3></span>
...
export default Create_Disclamer